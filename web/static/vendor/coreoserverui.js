...
var _pcstl$coreo_server$CoreoServerUI_VoteList$decodeEmptyResponse = _elm_lang$core$Json_Decode$succeed(
	{ctor: '_Tuple0'});
var _pcstl$coreo_server$CoreoServerUI_VoteList$resetVoteList = _elm_lang$core$List$map(
	function (vote) {
		return _elm_lang$core$Native_Utils.update(
			vote,
			{votes: 0});
	});
var _pcstl$coreo_server$CoreoServerUI_VoteList$decrement = function (x) {
	return x - 1;
};
var _pcstl$coreo_server$CoreoServerUI_VoteList$increment = function (x) {
	return x + 1;
};
var _pcstl$coreo_server$CoreoServerUI_VoteList$dispatchAction = F3(
	function (action, target, list) {
		var _p0 = list;
		if (_p0.ctor === '::') {
			var _p2 = _p0._0;
			var _p1 = _p0._1;
			return _elm_lang$core$Native_Utils.eq(_p2.id, target) ? A2(
				_elm_lang$core$List_ops['::'],
				_elm_lang$core$Native_Utils.update(
					_p2,
					{
						votes: action(_p2.votes)
					}),
				_p1) : A2(
				_elm_lang$core$List_ops['::'],
				_p2,
				A3(_pcstl$coreo_server$CoreoServerUI_VoteList$dispatchAction, action, target, _p1));
		} else {
			return _elm_lang$core$Native_List.fromArray(
				[]);
		}
	});
var _pcstl$coreo_server$CoreoServerUI_VoteList$subscriptions = function (_p3) {
	return _elm_lang$core$Platform_Sub$none;
};
var _pcstl$coreo_server$CoreoServerUI_VoteList$Votes = F3(
	function (a, b, c) {
		return {id: a, name: b, votes: c};
	});
var _pcstl$coreo_server$CoreoServerUI_VoteList$mostVoted = function (list) {
	return function (_) {
		return _.name;
	}(
		A2(
			_elm_lang$core$Maybe$withDefault,
			A3(_pcstl$coreo_server$CoreoServerUI_VoteList$Votes, 0, '', 0),
			_elm_lang$core$List$head(list)));
};
var _pcstl$coreo_server$CoreoServerUI_VoteList$decodeVote = A4(
	_elm_lang$core$Json_Decode$object3,
	_pcstl$coreo_server$CoreoServerUI_VoteList$Votes,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'votes', _elm_lang$core$Json_Decode$int));
var _pcstl$coreo_server$CoreoServerUI_VoteList$decodeVoteList = function () {
	var vList = _elm_lang$core$Json_Decode$list(_pcstl$coreo_server$CoreoServerUI_VoteList$decodeVote);
	return A2(_elm_lang$core$Json_Decode_ops[':='], 'data', vList);
}();
var _pcstl$coreo_server$CoreoServerUI_VoteList$decodeVoteResponse = A2(_elm_lang$core$Json_Decode_ops[':='], 'data', _pcstl$coreo_server$CoreoServerUI_VoteList$decodeVote);
var _pcstl$coreo_server$CoreoServerUI_VoteList$Model = F3(
	function (a, b, c) {
		return {currentWord: a, votes: b, url: c};
	});
var _pcstl$coreo_server$CoreoServerUI_VoteList$init = function (url) {
	return {
		ctor: '_Tuple2',
		_0: A3(
			_pcstl$coreo_server$CoreoServerUI_VoteList$Model,
			'',
			_elm_lang$core$Native_List.fromArray(
				[]),
			url),
...
var _pcstl$coreo_server$CoreoServerUI_VoteList$RemoveSucceed = function (a) {
	return {ctor: 'RemoveSucceed', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_VoteList$RemoveFail = function (a) {
	return {ctor: 'RemoveFail', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_VoteList$RemoveWord = function (a) {
	return {ctor: 'RemoveWord', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_VoteList$listElem = function (vote) {
	return A2(
...
var _pcstl$coreo_server$CoreoServerUI_VoteList$voteList = function (vList) {
	var list = A2(_elm_lang$core$List$map, _pcstl$coreo_server$CoreoServerUI_VoteList$listElem, vList);
	return A2(
...
var _pcstl$coreo_server$CoreoServerUI_VoteList$ResetSucceed = function (a) {
	return {ctor: 'ResetSucceed', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_VoteList$ResetFail = function (a) {
	return {ctor: 'ResetFail', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_VoteList$ResetList = {ctor: 'ResetList'};
var _pcstl$coreo_server$CoreoServerUI_VoteList$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'Palavra atual: ', model.currentWord))
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Votos atuais: ')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_pcstl$coreo_server$CoreoServerUI_VoteList$voteList(model.votes)
					])),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Reiniciar votos')
					]))
			]));
};
var _pcstl$coreo_server$CoreoServerUI_VoteList$UpdateListSucceed = function (a) {
	return {ctor: 'UpdateListSucceed', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_VoteList$UpdateListFail = function (a) {
	return {ctor: 'UpdateListFail', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_VoteList$update = F2(
		...
		switch (_p4.ctor) {
			case 'FetchList':
				return {
					...
					_1: A3(
						...
						_pcstl$coreo_server$CoreoServerUI_VoteList$UpdateListFail,
						_pcstl$coreo_server$CoreoServerUI_VoteList$UpdateListSucceed,
						A2(_evancz$elm_http$Http$get, _pcstl$coreo_server$CoreoServerUI_VoteList$decodeVoteList, model.url))
				};
			case 'UpdateListFail':
				return {
					ctor: '_Tuple2',
					_0: A2(_elm_lang$core$Debug$log, 'Could not get vList', model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			...
			case 'ResetList':
				return {
					...
					_1: A3(
						_elm_lang$core$Task$perform,
						_pcstl$coreo_server$CoreoServerUI_VoteList$ResetFail,
						_pcstl$coreo_server$CoreoServerUI_VoteList$ResetSucceed,
						A3(
							_evancz$elm_http$Http$post,
							_pcstl$coreo_server$CoreoServerUI_VoteList$decodeEmptyResponse,
							A2(_elm_lang$core$Basics_ops['++'], model.url, 'reset/'),
			...
			case 'RemoveWord':
				...
				return {
					...
					_1: A3(
						_elm_lang$core$Task$perform,
						_pcstl$coreo_server$CoreoServerUI_VoteList$RemoveFail,
						_pcstl$coreo_server$CoreoServerUI_VoteList$RemoveSucceed,
						A2(_evancz$elm_http$Http$fromJson, _pcstl$coreo_server$CoreoServerUI_VoteList$decodeEmptyResponse, httpRequest))
				};
			case 'RemoveFail':
				return {
					ctor: '_Tuple2',
			...
			case 'WordUpdate':
				var data = A2(_elm_lang$core$Json_Decode$decodeValue, _pcstl$coreo_server$CoreoServerUI_VoteList$decodeVote, _p4._0);
				var _p5 = data;
				if (_p5.ctor === 'Ok') {
					var _p6 = _p5._0;
					var updated = A3(
						_pcstl$coreo_server$CoreoServerUI_VoteList$dispatchAction,
						_elm_lang$core$Basics$always(_p6.votes),
						_p6.id,
						model.votes);
					var sorted = A2(
						_elm_lang$core$List$sortBy,
					...
					return {
						...
						_0: A2(
							_elm_lang$core$Debug$log,
							A2(_elm_lang$core$Basics_ops['++'], 'got err ', _p5._0),
							model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
...
var _pcstl$coreo_server$CoreoServerUI_VoteList$FetchList = {ctor: 'FetchList'};

var _pcstl$coreo_server$CoreoServerUI_NewWordList$decodeEmptyResponse = _elm_lang$core$Json_Decode$succeed(
	{ctor: '_Tuple0'});
var _pcstl$coreo_server$CoreoServerUI_NewWordList$resetVoteList = _elm_lang$core$List$map(
	function (vote) {
		return _elm_lang$core$Native_Utils.update(
			vote,
			{votes: 0});
	});
var _pcstl$coreo_server$CoreoServerUI_NewWordList$decrement = function (x) {
	return x - 1;
};
var _pcstl$coreo_server$CoreoServerUI_NewWordList$increment = function (x) {
	return x + 1;
};
var _pcstl$coreo_server$CoreoServerUI_NewWordList$dispatchAction = F3(
	function (action, target, list) {
		var _p0 = list;
		if (_p0.ctor === '::') {
			var _p2 = _p0._0;
			...
			return _elm_lang$core$Native_Utils.eq(_p2.id, target) ? A2(
				...
				_elm_lang$core$List_ops['::'],
				_p2,
				A3(_pcstl$coreo_server$CoreoServerUI_NewWordList$dispatchAction, action, target, _p1));
		} else {
			return _elm_lang$core$Native_List.fromArray(
				[]);
		}
	});
var _pcstl$coreo_server$CoreoServerUI_NewWordList$subscriptions = function (_p3) {
	return _elm_lang$core$Platform_Sub$none;
};
var _pcstl$coreo_server$CoreoServerUI_NewWordList$Votes = F3(
	function (a, b, c) {
		return {id: a, name: b, votes: c};
	});
var _pcstl$coreo_server$CoreoServerUI_NewWordList$decodeVote = A4(
	_elm_lang$core$Json_Decode$object3,
	_pcstl$coreo_server$CoreoServerUI_NewWordList$Votes,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'votes', _elm_lang$core$Json_Decode$int));
var _pcstl$coreo_server$CoreoServerUI_NewWordList$decodeVoteList = function () {
	var vList = _elm_lang$core$Json_Decode$list(_pcstl$coreo_server$CoreoServerUI_NewWordList$decodeVote);
	return A2(_elm_lang$core$Json_Decode_ops[':='], 'data', vList);
}();
var _pcstl$coreo_server$CoreoServerUI_NewWordList$decodeVoteResponse = A2(_elm_lang$core$Json_Decode_ops[':='], 'data', _pcstl$coreo_server$CoreoServerUI_NewWordList$decodeVote);
var _pcstl$coreo_server$CoreoServerUI_NewWordList$Model = F2(
	function (a, b) {
		return {votes: a, url: b};
	});
var _pcstl$coreo_server$CoreoServerUI_NewWordList$NewWordUpdate = function (a) {
	return {ctor: 'NewWordUpdate', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_NewWordList$ResetSucceed = function (a) {
	return {ctor: 'ResetSucceed', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_NewWordList$ResetFail = function (a) {
	return {ctor: 'ResetFail', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_NewWordList$ResetList = {ctor: 'ResetList'};
var _pcstl$coreo_server$CoreoServerUI_NewWordList$RemoveSucceed = function (a) {
	return {ctor: 'RemoveSucceed', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_NewWordList$RemoveFail = function (a) {
	return {ctor: 'RemoveFail', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_NewWordList$RemoveWord = function (a) {
	return {ctor: 'RemoveWord', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_NewWordList$listElem = function (vote) {
	return A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _pcstl$coreo_server$CoreoServerUI_NewWordList$voteList = function (vList) {
	var list = A2(_elm_lang$core$List$map, _pcstl$coreo_server$CoreoServerUI_NewWordList$listElem, vList);
	return A2(
		_elm_lang$html$Html$ul,
		_elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Votos para nova palavra: ')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_pcstl$coreo_server$CoreoServerUI_NewWordList$voteList(model.votes)
					])),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Reiniciar votos de nova palavra')
					]))
			]));
};
var _pcstl$coreo_server$CoreoServerUI_NewWordList$UpdateListSucceed = function (a) {
	return {ctor: 'UpdateListSucceed', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_NewWordList$UpdateListFail = function (a) {
	return {ctor: 'UpdateListFail', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI_NewWordList$init = function (url) {
	return {
		ctor: '_Tuple2',
		_0: A2(
			_pcstl$coreo_server$CoreoServerUI_NewWordList$Model,
			_elm_lang$core$Native_List.fromArray(
				[]),
			url),
		_1: A3(
			_elm_lang$core$Task$perform,
			_pcstl$coreo_server$CoreoServerUI_NewWordList$UpdateListFail,
			_pcstl$coreo_server$CoreoServerUI_NewWordList$UpdateListSucceed,
			A2(_evancz$elm_http$Http$get, _pcstl$coreo_server$CoreoServerUI_NewWordList$decodeVoteList, url))
	};
};
var _pcstl$coreo_server$CoreoServerUI_NewWordList$update = F2(
	function (message, model) {
		var _p4 = message;
		switch (_p4.ctor) {
			case 'FetchList':
				return {
					...
					_1: A3(
						...
						_pcstl$coreo_server$CoreoServerUI_NewWordList$UpdateListFail,
						_pcstl$coreo_server$CoreoServerUI_NewWordList$UpdateListSucceed,
						A2(_evancz$elm_http$Http$get, _pcstl$coreo_server$CoreoServerUI_NewWordList$decodeVoteList, model.url))
				};
			case 'UpdateListFail':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'UpdateListSucceed':
			...
			case 'ResetList':
				return {
					...
					_1: A3(
						_elm_lang$core$Task$perform,
						_pcstl$coreo_server$CoreoServerUI_NewWordList$ResetFail,
						_pcstl$coreo_server$CoreoServerUI_NewWordList$ResetSucceed,
						A3(
							_evancz$elm_http$Http$post,
							_pcstl$coreo_server$CoreoServerUI_NewWordList$decodeEmptyResponse,
							A2(_elm_lang$core$Basics_ops['++'], model.url, 'reset/'),
							_evancz$elm_http$Http$empty))
				};
			case 'ResetFail':
			...
			case 'RemoveWord':
				...
				return {
					...
					_1: A3(
						_elm_lang$core$Task$perform,
						_pcstl$coreo_server$CoreoServerUI_NewWordList$RemoveFail,
						_pcstl$coreo_server$CoreoServerUI_NewWordList$RemoveSucceed,
						A2(_evancz$elm_http$Http$fromJson, _pcstl$coreo_server$CoreoServerUI_NewWordList$decodeEmptyResponse, httpRequest))
				};
			case 'RemoveFail':
				return {
					ctor: '_Tuple2',
			...
			case 'RemoveSucceed':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				var data = A2(_elm_lang$core$Json_Decode$decodeValue, _pcstl$coreo_server$CoreoServerUI_NewWordList$decodeVote, _p4._0);
				var _p5 = data;
				if (_p5.ctor === 'Ok') {
					var _p6 = _p5._0;
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								votes: A3(
									_pcstl$coreo_server$CoreoServerUI_NewWordList$dispatchAction,
									_elm_lang$core$Basics$always(_p6.votes),
									_p6.id,
									model.votes)
							}),
...
var _pcstl$coreo_server$CoreoServerUI$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {voteList: a, newWordList: b, updateFrequency: c, remainingTime: d, isNWListLocked: e, isWListLocked: f, socket: g, socketUrl: h, updatesChannel: i, fieldContent: j};
									};
								};
							};
						};
...
var _pcstl$coreo_server$CoreoServerUI$WLockStateFail = function (a) {
	return {ctor: 'WLockStateFail', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI$LockStateSucceed = function (a) {
	return {ctor: 'LockStateSucceed', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI$LockStateFail = function (a) {
	return {ctor: 'LockStateFail', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI$SetVideoSucceed = function (a) {
	return {ctor: 'SetVideoSucceed', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI$SetVideoFail = function (a) {
	return {ctor: 'SetVideoFail', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI$SetVideo = function (a) {
	return {ctor: 'SetVideo', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI$videoForm = function (model) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$placeholder('Insira o código do YouTube'),
								_elm_lang$html$Html_Events$onInput(_pcstl$coreo_server$CoreoServerUI$NewContent),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$class('btn btn-secondary'),
								_elm_lang$html$Html_Events$onClick(
								_pcstl$coreo_server$CoreoServerUI$SetVideo(model.fieldContent))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Confirmar vídeo')
							]))
					]))
			]));
};
var _pcstl$coreo_server$CoreoServerUI$PhoenixMsg = function (a) {
	return {ctor: 'PhoenixMsg', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI$NewWordUpdate = function (a) {
	return {ctor: 'NewWordUpdate', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI$WordUpdate = function (a) {
	return {ctor: 'WordUpdate', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI$FetchWords = function (a) {
	return {ctor: 'FetchWords', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI$FetchNewWords = function (a) {
	return {ctor: 'FetchNewWords', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI$FetchLists = function (a) {
	return {ctor: 'FetchLists', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI$ToggleWLockSucceed = {ctor: 'ToggleWLockSucceed'};
var _pcstl$coreo_server$CoreoServerUI$ToggleWLockFail = {ctor: 'ToggleWLockFail'};
var _pcstl$coreo_server$CoreoServerUI$ToggleWListLock = {ctor: 'ToggleWListLock'};
var _pcstl$coreo_server$CoreoServerUI$ToggleNWLockSucceed = {ctor: 'ToggleNWLockSucceed'};
var _pcstl$coreo_server$CoreoServerUI$ToggleNWLockFail = {ctor: 'ToggleNWLockFail'};
var _pcstl$coreo_server$CoreoServerUI$ToggleNWListLock = {ctor: 'ToggleNWListLock'};
var _pcstl$coreo_server$CoreoServerUI$NewWordMsg = function (a) {
	return {ctor: 'NewWordMsg', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI$VoteListMsg = function (a) {
	return {ctor: 'VoteListMsg', _0: a};
};
var _pcstl$coreo_server$CoreoServerUI$init = function () {
	var wLockCmd = A3(
		_elm_lang$core$Task$perform,
		_pcstl$coreo_server$CoreoServerUI$WLockStateFail,
		_pcstl$coreo_server$CoreoServerUI$WLockStateSucceed,
		A2(
			_evancz$elm_http$Http$get,
			_pcstl$coreo_server$CoreoServerUI$decodeLockState,
			A2(_elm_lang$core$Basics_ops['++'], _pcstl$coreo_server$CoreoServerUI$wordsUrl, 'lock_state/')));
	var lockCmd = A3(
		_elm_lang$core$Task$perform,
		_pcstl$coreo_server$CoreoServerUI$LockStateFail,
		_pcstl$coreo_server$CoreoServerUI$LockStateSucceed,
		A2(
			_evancz$elm_http$Http$get,
			_pcstl$coreo_server$CoreoServerUI$decodeLockState,
			A2(_elm_lang$core$Basics_ops['++'], _pcstl$coreo_server$CoreoServerUI$newWordsUrl, 'lock_state/')));
	var channel = A2(
	...
	var socket = _p0._0;
	var phxCmd = _p0._1;
	var _p1 = _pcstl$coreo_server$CoreoServerUI_NewWordList$init(_pcstl$coreo_server$CoreoServerUI$newWordsUrl);
	var initialNWordList = _p1._0;
	var nwListCmd = _p1._1;
	var _p2 = _pcstl$coreo_server$CoreoServerUI_VoteList$init(_pcstl$coreo_server$CoreoServerUI$wordsUrl);
	var initialVoteList = _p2._0;
	var voteListCmd = _p2._1;
	return {
		ctor: '_Tuple2',
		_0: {voteList: initialVoteList, newWordList: initialNWordList, updateFrequency: _pcstl$coreo_server$CoreoServerUI$initialFreq, remainingTime: 60, isNWListLocked: true, isWListLocked: true, socket: socket, socketUrl: _pcstl$coreo_server$CoreoServerUI$socketUrl, updatesChannel: channel, fieldContent: ''},
		_1: _elm_lang$core$Platform_Cmd$batch(
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_elm_lang$core$Platform_Cmd$map, _pcstl$coreo_server$CoreoServerUI$VoteListMsg, voteListCmd),
					A2(_elm_lang$core$Platform_Cmd$map, _pcstl$coreo_server$CoreoServerUI$NewWordMsg, nwListCmd),
					A2(_elm_lang$core$Platform_Cmd$map, _pcstl$coreo_server$CoreoServerUI$PhoenixMsg, phxCmd),
					lockCmd,
					wLockCmd
				]))
	};
}();
var _pcstl$coreo_server$CoreoServerUI$update = F2(
	function (message, model) {
		var _p3 = message;
		switch (_p3.ctor) {
			case 'VoteListMsg':
				var _p4 = A2(_pcstl$coreo_server$CoreoServerUI_VoteList$update, _p3._0, model.voteList);
				var newVoteList = _p4._0;
				var voteListCmd = _p4._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{voteList: newVoteList}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _pcstl$coreo_server$CoreoServerUI$VoteListMsg, voteListCmd)
				};
			case 'NewWordMsg':
				var _p5 = A2(_pcstl$coreo_server$CoreoServerUI_NewWordList$update, _p3._0, model.newWordList);
				var newNWList = _p5._0;
				var nwListCmd = _p5._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{newWordList: newNWList}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _pcstl$coreo_server$CoreoServerUI$NewWordMsg, nwListCmd)
				};
			case 'ToggleNWListLock':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A3(
						_elm_lang$core$Task$perform,
						function (_p6) {
							return _pcstl$coreo_server$CoreoServerUI$ToggleNWLockFail;
						},
						function (_p7) {
							return _pcstl$coreo_server$CoreoServerUI$ToggleNWLockSucceed;
						},
						A3(
							_evancz$elm_http$Http$post,
							_elm_lang$core$Json_Decode$succeed(''),
							A2(_elm_lang$core$Basics_ops['++'], _pcstl$coreo_server$CoreoServerUI$adminUrl, 'lock_new_words/'),
							_evancz$elm_http$Http$empty))
				};
			case 'ToggleNWLockFail':
				return {
					ctor: '_Tuple2',
					_0: A2(_elm_lang$core$Debug$log, 'could not toggle list lock', model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ToggleNWLockSucceed':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							isNWListLocked: _elm_lang$core$Basics$not(model.isNWListLocked)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ToggleWListLock':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A3(
						_elm_lang$core$Task$perform,
						function (_p8) {
							return _pcstl$coreo_server$CoreoServerUI$ToggleWLockFail;
						},
						function (_p9) {
							return _pcstl$coreo_server$CoreoServerUI$ToggleWLockSucceed;
						},
						A3(
							_evancz$elm_http$Http$post,
							_elm_lang$core$Json_Decode$succeed(''),
							A2(_elm_lang$core$Basics_ops['++'], _pcstl$coreo_server$CoreoServerUI$adminUrl, 'lock_words/'),
							_evancz$elm_http$Http$empty))
				};
			case 'ToggleWLockFail':
				return {
					ctor: '_Tuple2',
					_0: A2(_elm_lang$core$Debug$log, 'could not toggle wlist lock', model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ToggleWLockSucceed':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							isWListLocked: _elm_lang$core$Basics$not(model.isWListLocked)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'FetchLists':
				var _p10 = A2(_pcstl$coreo_server$CoreoServerUI_NewWordList$update, _pcstl$coreo_server$CoreoServerUI_NewWordList$FetchList, model.newWordList);
				var newWordList = _p10._0;
				var wordListCmd = _p10._1;
				var _p11 = A2(_pcstl$coreo_server$CoreoServerUI_VoteList$update, _pcstl$coreo_server$CoreoServerUI_VoteList$FetchList, model.voteList);
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{voteList: newVoteList, newWordList: newWordList}),
					_1: _elm_lang$core$Platform_Cmd$batch(
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_elm_lang$core$Platform_Cmd$map, _pcstl$coreo_server$CoreoServerUI$VoteListMsg, voteListCmd),
								A2(_elm_lang$core$Platform_Cmd$map, _pcstl$coreo_server$CoreoServerUI$NewWordMsg, wordListCmd)
							]))
				};
			case 'FetchNewWords':
				var _p12 = A2(_pcstl$coreo_server$CoreoServerUI_NewWordList$update, _pcstl$coreo_server$CoreoServerUI_NewWordList$FetchList, model.newWordList);
				var newWordList = _p12._0;
				var wordListCmd = _p12._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'FetchWords':
				var _p13 = A2(_pcstl$coreo_server$CoreoServerUI_VoteList$update, _pcstl$coreo_server$CoreoServerUI_VoteList$FetchList, model.voteList);
				var newVoteList = _p13._0;
				var voteListCmd = _p13._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'WordUpdate':
				var _p14 = A2(
					...
					_pcstl$coreo_server$CoreoServerUI_VoteList$WordUpdate(_p3._0),
					model.voteList);
				var newVoteList = _p14._0;
				var voteListCmd = _p14._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'NewWordUpdate':
				var _p15 = A2(
					_pcstl$coreo_server$CoreoServerUI_NewWordList$update,
					_pcstl$coreo_server$CoreoServerUI_NewWordList$NewWordUpdate(_p3._0),
					model.newWordList);
				var newWordList = _p15._0;
				var wordListCmd = _p15._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{newWordList: newWordList}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _pcstl$coreo_server$CoreoServerUI$NewWordMsg, wordListCmd)
				};
			case 'NewContent':
				return {
					ctor: '_Tuple2',
			...
			case 'SetVideo':
				...
				var httpRequest = A2(
					...
					_evancz$elm_http$Http$defaultSettings,
					{
						...
						url: A2(_elm_lang$core$Basics_ops['++'], _pcstl$coreo_server$CoreoServerUI$adminUrl, 'set_video/'),
						body: _evancz$elm_http$Http$string(
							A2(_elm_lang$core$Debug$log, 'payload', payload))
					});
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A3(
						_elm_lang$core$Task$perform,
						_pcstl$coreo_server$CoreoServerUI$SetVideoFail,
						_pcstl$coreo_server$CoreoServerUI$SetVideoSucceed,
						A2(
							_evancz$elm_http$Http$fromJson,
							_elm_lang$core$Json_Decode$succeed(''),
							httpRequest))
			...
			case 'LockStateSucceed':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{isNWListLocked: _p3._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'WLockStateFail':
				return {
			...
			case 'PhoenixMsg':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{socket: phxSocket}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _pcstl$coreo_server$CoreoServerUI$PhoenixMsg, phxCmd)
				};
			default:
				var ping = A2(
...
var _pcstl$coreo_server$CoreoServerUI$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				_pcstl$coreo_server$CoreoServerUI$videoForm(model),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						model.isWListLocked ? 'Iniciar votação' : 'Encerrar votação')
					])),
				A2(
				_elm_lang$html$Html_App$map,
				_pcstl$coreo_server$CoreoServerUI$VoteListMsg,
				_pcstl$coreo_server$CoreoServerUI_VoteList$view(model.voteList)),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						model.isNWListLocked ? 'Desbloquear criação de novas palavras' : 'Bloquear criação de novas palavras')
					])),
				A2(
				_elm_lang$html$Html_App$map,
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Platform_Sub$map,
				_pcstl$coreo_server$CoreoServerUI$VoteListMsg,
				_pcstl$coreo_server$CoreoServerUI_VoteList$subscriptions(model.voteList)),
				A2(
				_elm_lang$core$Platform_Sub$map,
				_pcstl$coreo_server$CoreoServerUI$NewWordMsg,
				_pcstl$coreo_server$CoreoServerUI_NewWordList$subscriptions(model.newWordList)),
				A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.socket, _pcstl$coreo_server$CoreoServerUI$PhoenixMsg),
				A2(
				_elm_lang$core$Time$every,
...
var _pcstl$coreo_server$CoreoServerUI$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _pcstl$coreo_server$CoreoServerUI$init, view: _pcstl$coreo_server$CoreoServerUI$view, update: _pcstl$coreo_server$CoreoServerUI$update, subscriptions: _pcstl$coreo_server$CoreoServerUI$subscriptions})
};

var Elm = {};
Elm['CoreoServerUI'] = Elm['CoreoServerUI'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['CoreoServerUI'], 'CoreoServerUI', typeof _pcstl$coreo_server$CoreoServerUI$main === 'undefined' ? null : _pcstl$coreo_server$CoreoServerUI$main);
